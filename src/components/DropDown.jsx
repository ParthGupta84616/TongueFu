      ...
      <AnimatePresence>
        {showFlyout && (
          <motion.div
            ...
            className="absolute  top-12 bg-white text-black"
            style ={{ width : "700px" }}
          >
            <div className="absolute -top-6 left-0 right-0 h-6 bg-transparent" />
            <div className="absolute left-10 top-0 h-4 w-4 -translate-x-1/2 -translate-y-1/2 rotate-45 bg-white" />
            <FlyoutContent />
          </motion.div>
        )}
      </AnimatePresence>
...
const PricingContent = () => {
  return (
      <div className="flex p-5 bg-white shadow-xl ">
        <div className="w-4/5 mr-5 text-neutral-800">
