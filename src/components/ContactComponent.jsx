...
function ContactComponent() {
  return (
    ...
    <div class="grid grid-cols-1 md:grid-cols-12 border shadow-lg shadow-slate-700">
  ...
  <g>
    ...
    <FaPhone />
            ...
            <div class="flex items-center mt-5">
            <svg className="h-6 mr-2 text-indigo-600" fill="currentColor" viewBox="0 0 300.988 300.988" xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink">
                    <g>
                        <g>
