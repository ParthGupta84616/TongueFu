...
function ContactComponent() {
  return (
    ...
    <div class="grid grid-cols-1 md:grid-cols-12 border shadow-lg rounded-3xl  shadow-slate-700">
        <div class="bg-gray-900 md:col-span-4 p-10 text-white rounded-3xl">
            ...
            We understand stammering can be a frustrating challenge, and we're here to help you on your journey towards smoother communication. If you have any questions about our programs, stammering in general, or would like to speak to a specialist, don't hesitate to reach out. We're here to offer support and guidance every step of the way.
            </p>

            <div class="flex items-center mt-5">
            <svg className="h-6 mr-2 text-black" fill="currentColor" viewBox="0 0 489.536 489.536">
      <g>
        <g>
          </g>
      </g>
    </svg>
    <FaMapMarkerAlt size={32} color='indigo' className='-ml-6 m-2' />
                <span class="text-sm">Acropolis Institute of technology and research, Indore</span>
            </div>
            <div class="flex items-center mt-5">
  ...
  <g>
    ...
    <FaPhone size={26} color='indigo' className='-ml-8 m-2' />

                <span class="text-sm">Call us: +91 620 26 999 35</span>
                
            </div>
            <div class="flex items-center mt-5">
            <svg className="h-6 mr-2 text-indigo-700" fill="currentColor" viewBox="0 0 300.988 300.988" xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink">
                    <g>
                        <g>
            ...
            <div class="flex flex-wrap -mx-3 mb-6">
                <div class="w-full px-3">
                    ...
                    <input
                        ...
                        id="grid-email" type="email" placeholder="Enter your mail ID" />
                </div>
            </div>
