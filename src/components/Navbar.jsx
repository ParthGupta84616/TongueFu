...
function NavBar() {
  ...
  <div class='flex flex-wrap items-center justify-between gap-5 w-full'>
    <Link to={"/"}><img src={logo} alt="logo" class='w-44' />
    </Link>
    ...
    <div id="collapseMenu"
      ...
      <ul
        ...
        {/* <li class='max-lg:border-b border-gray-300 max-lg:py-3 px-3'><Link href='javascript:void(0)'
            class='hover:text-[#007bff] text-gray-500 block font-semibold text-[15px]'>Team</Link>
        </li> */}
        <li class='max-lg:border-b border-gray-300 max-lg:py-3 px-3'><Link href='javascript:void(0)'
        ...
        <li class='max-lg:border-b border-gray-300 max-lg:py-3 px-3'><Link to={"/faq"}
            class='hover:text-[#007bff] text-gray-500 block font-semibold text-[15px]'>FAQ</Link>
        </li>
      </ul>
    </div>
